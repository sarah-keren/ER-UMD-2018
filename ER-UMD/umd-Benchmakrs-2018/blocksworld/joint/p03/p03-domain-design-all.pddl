...
(define (problem p03-0-design-relaxed)
...
(define (problem p03-0-design-over)
...
(define (problem p03-0-design-over-relaxed)
...
(define (problem p03-0-design-tip)
  (:domain blocks-domain-design)
  (:objects t1 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)
...
(define (problem p03-1-design-relaxed)
  (:domain blocks-domain-design-relaxed)
  (:objects t1 t2 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)
...
(define (problem p03-1-design-over)
  (:domain blocks-domain-design-over)
  (:objects t1 t2 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)
...
(define (problem p03-1-design-over-relaxed)
  (:domain blocks-domain-design-over-relaxed)
  (:objects t1 t2 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)
...
(define (problem p03-1-design-tip)
  (:domain blocks-domain-design)
  (:objects t1 t2 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)
...
(define (problem p03-2-design-relaxed)
  (:domain blocks-domain-design-relaxed)
  (:objects t1 t2 t3 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)
...
(define (problem p03-2-design-over)
  (:domain blocks-domain-design-over)
  (:objects t1 t2 t3 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)
...
(define (problem p03-2-design-over-relaxed)
  (:domain blocks-domain-design-over-relaxed)
  (:objects t1 t2 t3 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)
...
(define (problem p03-2-design-tip)
  (:domain blocks-domain-design)
  (:objects t1 t2 t3 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)
...
(define (problem p03-3-design-relaxed)
  (:domain blocks-domain-design-relaxed)
  (:objects t1 t2 t3 t4 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)
...
(define (problem p03-3-design-over)
  (:domain blocks-domain-design-over)
  (:objects t1 t2 t3 t4 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)
...
(define (problem p03-3-design-over-relaxed)
  (:domain blocks-domain-design-over-relaxed)
  (:objects t1 t2 t3 t4 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)
...
(define (problem p03-3-design-tip)
  (:domain blocks-domain-design)
  (:objects t1 t2 t3 t4 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)
...
(define (problem p03-4-design-relaxed)
  (:domain blocks-domain-design-relaxed)
  (:objects t1 t2 t3 t4 t5 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)
...
(define (problem p03-4-design-over)
  (:domain blocks-domain-design-over)
  (:objects t1 t2 t3 t4 t5 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)
...
(define (problem p03-4-design-over-relaxed)
  (:domain blocks-domain-design-over-relaxed)
  (:objects t1 t2 t3 t4 t5 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)
...
(define (problem p03-4-design-tip)
  (:domain blocks-domain-design)
  (:objects t1 t2 t3 t4 t5 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)
...
(define (problem p03-5-design-relaxed)
  (:domain blocks-domain-design-relaxed)
  (:objects t1 t2 t3 t4 t5 t6 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)(next t5 t6)
...
(define (problem p03-5-design-over)
  (:domain blocks-domain-design-over)
  (:objects t1 t2 t3 t4 t5 t6 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)(next t5 t6)
...
(define (problem p03-5-design-over-relaxed)
  (:domain blocks-domain-design-over-relaxed)
  (:objects t1 t2 t3 t4 t5 t6 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)(next t5 t6)
...
(define (problem p03-5-design-tip)
  (:domain blocks-domain-design)
  (:objects t1 t2 t3 t4 t5 t6 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)(next t5 t6)
...
(define (problem p03-6-design-relaxed)
  (:domain blocks-domain-design-relaxed)
  (:objects t1 t2 t3 t4 t5 t6 t7 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)(next t5 t6)(next t6 t7)
...
(define (problem p03-6-design-over)
  (:domain blocks-domain-design-over)
  (:objects t1 t2 t3 t4 t5 t6 t7 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)(next t5 t6)(next t6 t7)
...
(define (problem p03-6-design-over-relaxed)
  (:domain blocks-domain-design-over-relaxed)
  (:objects t1 t2 t3 t4 t5 t6 t7 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)(next t5 t6)(next t6 t7)
...
(define (problem p03-6-design-tip)
  (:domain blocks-domain-design)
  (:objects t1 t2 t3 t4 t5 t6 t7 - time
 b1 b2 b3 b4 b5 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)(next t1 t2)(next t2 t3)(next t3 t4)(next t4 t5)(next t5 t6)(next t6 t7)
