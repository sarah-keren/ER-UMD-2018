...
(define (problem p7_design_0_relaxed)
  (:domain blocks-domain-design-relaxed)
  (:objects t1 - time
 b1 b2 b3 b4 b5 b6 - block)
  (:init (current-time t1)
 (emptyhand) (on b1 b2) (on-table b2) (on b3 b4) (on b4 b6) (on b5 b1) (on-table b6) (clear b3) (clear b5))
  (:goal (and (emptyhand) (on b1 b3) (on b2 b5) (on b3 b4) (on b4 b2) (on-table b5) (on b6 b1) (clear b6)))
  (:goal-reward 1)
  (:metric maximize (reward))
)
(define (problem p7_design_0)
...
(define (problem p7_design_1_relaxed)
  (:domain blocks-domain-design-relaxed)
  (:objects t1 t2 - time
 b1 b2 b3 b4 b5 b6 - block)
...
(define (problem p7_design_2_relaxed)
  (:domain blocks-domain-design-relaxed)
...
(define (problem p7_design_3_relaxed)
  (:domain blocks-domain-design-relaxed)
