...
(define (domain exploding-blocksworld-design)
 ...
 (:action pick-up-from-table
  ...
  (:action put-down
   ...
   :effect (and (emptyhand) (on-table ?b) (not (holding ?b))
                (probabilistic 0.4 (when (no-detonated ?b) (and (not (no-destroyed-table)) (not (no-detonated ?b))))))
  )
  ...
  (:action put-on-block
   ...
   :effect (and (emptyhand) (on ?b1 ?b2) (not (holding ?b1)) (not (clear ?b2))
                (probabilistic 0.1 (when (no-detonated ?b1) (and (not (no-destroyed ?b2)) (not (no-detonated ?b1))))))
  )
...
(define (problem p4)
  ...
  (:objects b1 b2 b3 b4 b5 b6 - block t1 t2 t3 t4 - time)
  (:init (current-time t3) (next t1 t2) (next t2 t3) (next t3 t4) (next t3 t4) (initialization) (emptyhand) (on b1 b5) (on b2 b4) (on b3 b1) (on-table b4) (on b5 b2) (on b6 b3) (clear b6) (no-detonated b1) (no-destroyed b1) (no-detonated b2) (no-destroyed b2) (no-detonated b3) (no-destroyed b3) (no-detonated b4) (no-destroyed b4) (no-detonated b5) (no-destroyed b5) (no-detonated b6) (no-destroyed b6) (no-destroyed-table))
...
(define (problem p4-0-design)
  ...
  (:objects t1 - time
 b1 b2 b3 b4 b5 b6 - block t1 t2 t3 t4 - time)
  (:init (current-time t1)
 (current-time t3) (next t1 t2) (next t2 t3) (next t3 t4) (next t3 t4) (init (current-time t1)
ialization) (emptyhand) (on b1 b5) (on b2 b4) (on b3 b1) (on-table b4) (on b5 b2) (on b6 b3) (clear b6) (no-detonated b1) (no-destroyed b1) (no-detonated b2) (no-destroyed b2) (no-detonated b3) (no-destroyed b3) (no-detonated b4) (no-destroyed b4) (no-detonated b5) (no-destroyed b5) (no-detonated b6) (no-destroyed b6) (no-destroyed-table))
  (:goal (and (on-table b3) (on-table b4) (on b5 b4) (on b6 b3)))
  (:goal-reward 1)
  (:metric maximize (reward))
)
