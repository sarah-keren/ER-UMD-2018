...
(define (problem p3_design_0_relaxed)
...
(define (problem p3_design_1_relaxed)
  (:domain blocks-domain-design-relaxed)
  (:objects t1 t2 - time
 b1 b2 b3 b4 - block)
...
(define (problem p3_design_2_relaxed)
  (:domain blocks-domain-design-relaxed)
...
(define (problem p3_design_3_relaxed)
  (:domain blocks-domain-design-relaxed)
