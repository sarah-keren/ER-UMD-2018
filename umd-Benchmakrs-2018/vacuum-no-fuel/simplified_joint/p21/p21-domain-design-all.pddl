...
;;the running example
(define (problem p21-0-design-relaxed)
...
;;the running example
(define (problem p21-0-design-over)
...
;;the running example
(define (problem p21-0-design-over-relaxed)
...
;;the running example
(define (problem p21-0-design-tip)
                   (:domain vacuum-no-fuel-design)
                   (:objects t1 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-1-design-relaxed)
                   (:domain vacuum-no-fuel-design-relaxed)
                   (:objects t1 t2 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-1-design-over)
                   (:domain vacuum-no-fuel-design-over)
                   (:objects t1 t2 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-1-design-over-relaxed)
                   (:domain vacuum-no-fuel-design-over-relaxed)
                   (:objects t1 t2 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-1-design-tip)
                   (:domain vacuum-no-fuel-design)
                   (:objects t1 t2 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-2-design-relaxed)
                   (:domain vacuum-no-fuel-design-relaxed)
                   (:objects t1 t2 t3 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-2-design-over)
                   (:domain vacuum-no-fuel-design-over)
                   (:objects t1 t2 t3 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-2-design-over-relaxed)
                   (:domain vacuum-no-fuel-design-over-relaxed)
                   (:objects t1 t2 t3 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-2-design-tip)
                   (:domain vacuum-no-fuel-design)
                   (:objects t1 t2 t3 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-3-design-relaxed)
                   (:domain vacuum-no-fuel-design-relaxed)
                   (:objects t1 t2 t3 t4 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-3-design-over)
                   (:domain vacuum-no-fuel-design-over)
                   (:objects t1 t2 t3 t4 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-3-design-over-relaxed)
                   (:domain vacuum-no-fuel-design-over-relaxed)
                   (:objects t1 t2 t3 t4 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-3-design-tip)
                   (:domain vacuum-no-fuel-design)
                   (:objects t1 t2 t3 t4 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-4-design-relaxed)
                   (:domain vacuum-no-fuel-design-relaxed)
                   (:objects t1 t2 t3 t4 t5 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-4-design-over)
                   (:domain vacuum-no-fuel-design-over)
                   (:objects t1 t2 t3 t4 t5 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-4-design-over-relaxed)
                   (:domain vacuum-no-fuel-design-over-relaxed)
                   (:objects t1 t2 t3 t4 t5 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-4-design-tip)
                   (:domain vacuum-no-fuel-design)
                   (:objects t1 t2 t3 t4 t5 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-5-design-relaxed)
                   (:domain vacuum-no-fuel-design-relaxed)
                   (:objects t1 t2 t3 t4 t5 t6 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-5-design-over)
                   (:domain vacuum-no-fuel-design-over)
                   (:objects t1 t2 t3 t4 t5 t6 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-5-design-over-relaxed)
                   (:domain vacuum-no-fuel-design-over-relaxed)
                   (:objects t1 t2 t3 t4 t5 t6 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-5-design-tip)
                   (:domain vacuum-no-fuel-design)
                   (:objects t1 t2 t3 t4 t5 t6 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-6-design-relaxed)
                   (:domain vacuum-no-fuel-design-relaxed)
                   (:objects t1 t2 t3 t4 t5 t6 t7 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-6-design-over)
                   (:domain vacuum-no-fuel-design-over)
                   (:objects t1 t2 t3 t4 t5 t6 t7 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-6-design-over-relaxed)
                   (:domain vacuum-no-fuel-design-over-relaxed)
                   (:objects t1 t2 t3 t4 t5 t6 t7 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
...
;;the running example
(define (problem p21-6-design-tip)
                   (:domain vacuum-no-fuel-design)
                   (:objects t1 t2 t3 t4 t5 t6 t7 - time
 x1 x2 x3 x4 x5 y1 y2 y3 y4 - location 
		              d1 - dirt)
